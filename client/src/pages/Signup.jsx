    ...
    <div className="flex min-h-screen items-center justify-center bg-bone px-4">
      <div className="w-full max-w-sm">
        <div className="mb-6 text-center">
          ...
          <h1 className="font-display text-2xl font-semibold text-graphite">Create your account</h1>
          <p className="mt-1 text-sm text-graphite/60">Start tracking work in minutes</p>
        </div>

        <form onSubmit={submit} className="stub-card p-6">
          <label className="text-xs font-medium uppercase tracking-wide text-graphite/50">Name</label>
          <input
          ...
          <label className="mt-4 block text-xs font-medium uppercase tracking-wide text-graphite/50">Email</label>
          <input
            className="field-input mt-1"
            type="email"
            value={email}
